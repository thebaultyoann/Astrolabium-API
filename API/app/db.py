...
SessionLocalUsers = sessionmaker(autocommit=False, autoflush=False, bind=engineUsers, class_=Users)
SessionLocalUsersAdmin = sessionmaker(autocommit=False, autoflush=False, bind=engineUserAdmin, class_=UserAdmin)
